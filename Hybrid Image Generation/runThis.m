...
image1 = im2single(imread('piano.png'));
image2 = im2single(imread('stairs.png'));

image1 = imresize(image1,[300 300]);
image2 = imresize(image2,[300 300]);
...
highFrequencies = grayImage2 - imfilter(grayImage2,filter2);
